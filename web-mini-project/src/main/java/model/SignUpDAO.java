...
//	}
	...
	public static MemberDTO getMember(String id) throws Exception { // getInfo와 중복
		EntityManager em = PublicCommon.getEntityManager();
		EntityTransaction tx = em.getTransaction();
		...
		try {
			...
			member = em.createNamedQuery("Member.findOne", Member.class).setParameter("id", id).getSingleResult();
